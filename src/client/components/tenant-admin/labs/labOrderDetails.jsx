...
const LabOrderDetailsTable = () => {
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: "providerName", // simple recommended way to define a column
      ...
      {
        accessorKey: "orderType", // simple recommended way to define a column
        header: "Order Type",
        Cell: ({ cell }) => <span>{cell.getValue()}</span> // optional custom cell render
      },
      {
  ...
  const { orderList: data, loading } = useSelector((state) => state.labs);
...
export default LabOrderDetailsTable;
