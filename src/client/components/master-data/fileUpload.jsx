...
import { codeMap, updateAboutUs } from "../../redux/slices/masterDataSlice";
...
export const FileUpload = ({ open, setOpen }) => {
  ...
  const updateFile = async () => {
    ...
    // dispatch(codeMap(formData));

    setIsLoading(true);

    try {
      const response = await dispatch(codeMap(formData));
    ...
    <>
      ...
      >
        <Box className="commonModal__wrapper--dialog">
          ...
          <DialogTitle> Add CodeMap </DialogTitle>
